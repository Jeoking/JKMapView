...
+ (UIColor *)colorWithTrafficStatus:(NSString *)status
{
    ...
    if (colorMapping == nil)
    {
        colorMapping = @{@"未知":UIColorFromRGB(0x458de8),
                         @"畅通":UIColorFromRGB(0x458de8),
...
- (id)init
{
    ...
    if (self)
    {
        ...
        self.routeColor = UIColorFromRGB(0x458de8);
        self.walkingColor = [UIColor cyanColor];
        self.railwayColor = [UIColor yellowColor];
        
        self.trafficColors = @[UIColorFromRGB(0x458de8), UIColorFromRGB(0x458de8), [UIColor yellowColor], [UIColor redColor]];
    }
